# Generated by Django 5.0.4 on 2024-04-08 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='scrolling_text.author')),
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='scrolling_text.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='scrolling_text.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
